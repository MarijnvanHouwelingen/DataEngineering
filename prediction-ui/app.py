        ...
        prediction_input = [
            {
                ...
                "Car_Owner": int(request.form.get("dropdownCar")),  # getting input with name = dropdownCar in HTML form
                "Propert_Owner": int(request.form.get("dropdownProperty")), # getting input with name = dropdownProperty in HTML form
                "CHILDREN": int(request.form.get("nrchildren")), # getting input with name = nrchildren in HTML form
                "Annual_income": int(request.form.get("annualincome")), # getting input with name = annualincome in HTML form
            }
        ]
